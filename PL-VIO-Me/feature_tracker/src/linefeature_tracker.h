...
public:
    ...
    vector<Line> vecLine;///季哥的line，也是最后保存的line形式
    vector< int > lineID;
    ...
    ///
    /////EDLines::EDLines Linestrack(Mat img);
    std::vector<struct LineSegment> EDLS;
    vector<int> EDlineID;///最终保存的lineID
};
...
class LineFeatureTracker
{
  public:
    ...
    FrameLinesPtr curframe_, forwframe_,preframe_;
